  ...
  html_ullist = {
    html_a: function(i, hash, ttl) {
      var self = this,
        ...
        el_a = $('<li class = "'+ visited +'"><a data-load="' + index + '" id="ullist_a_' + index + '" href="#' + index + '" title="' + title + '">'
          // <span>' + (title || ('#' + (i + 1))) + '</span>'
          + '</a></li>');
    ...
    getHtml: function() {
      var html = $('<ul class=\'ullist controls ' + this.o.controls_cssclass + '\'></ul>').css(this.o.controls_applycss ? {
        ...
        // visited = !!(this.o.locations[i] && this.o.locations[i].visited) ? "visited" : "",
        title, a;

      if (this.ShowOnMenu(this.view_all_key)) {
        html.append(html_ullist.html_a.call(this, false, this.view_all_key, this.o.view_all_text));
      }

      for (a = 0; a < this.ln; a++) {
        if (this.ShowOnMenu(a)) {
          html.append(html_ullist.html_a.call(this, a));
        }
      }
